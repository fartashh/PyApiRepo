...
> - Your local ***documents are not shared between differen***t browsers or computers.
...
You can renam**e the current documen**t by clicking the document title in the navigation bar.
